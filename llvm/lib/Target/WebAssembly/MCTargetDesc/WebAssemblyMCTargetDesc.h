...
#define WASM_LOAD_STORE_SAFE(NAME) \
  case WebAssembly::NAME##_A32: \
  case WebAssembly::NAME##_A64: \
  case WebAssembly::NAME##_A32_S: \
  case WebAssembly::NAME##_A64_S: \
  case WebAssembly::NAME##_A32_SAFE: \
  case WebAssembly::NAME##_A64_SAFE:
  WASM_LOAD_STORE_SAFE(LOAD8_S_I32)
  WASM_LOAD_STORE_SAFE(LOAD8_U_I32)
  WASM_LOAD_STORE_SAFE(LOAD8_S_I64)
  WASM_LOAD_STORE_SAFE(LOAD8_U_I64)
  WASM_LOAD_STORE_SAFE(ATOMIC_LOAD8_U_I32)
  WASM_LOAD_STORE_SAFE(ATOMIC_LOAD8_U_I64)
  WASM_LOAD_STORE_SAFE(STORE8_I32)
  WASM_LOAD_STORE_SAFE(STORE8_I64)
  WASM_LOAD_STORE_SAFE(ATOMIC_STORE8_I32)
  WASM_LOAD_STORE_SAFE(ATOMIC_STORE8_I64)
  ...
  return 0;
  WASM_LOAD_STORE_SAFE(LOAD16_S_I32)
  WASM_LOAD_STORE_SAFE(LOAD16_U_I32)
  WASM_LOAD_STORE_SAFE(LOAD16_S_I64)
  WASM_LOAD_STORE_SAFE(LOAD16_U_I64)
  WASM_LOAD_STORE_SAFE(ATOMIC_LOAD16_U_I32)
  WASM_LOAD_STORE_SAFE(ATOMIC_LOAD16_U_I64)
  WASM_LOAD_STORE_SAFE(STORE16_I32)
  WASM_LOAD_STORE_SAFE(STORE16_I64)
  WASM_LOAD_STORE_SAFE(ATOMIC_STORE16_I32)
  WASM_LOAD_STORE_SAFE(ATOMIC_STORE16_I64)
  ...
  return 1;
  WASM_LOAD_STORE_SAFE(LOAD_I32)
  WASM_LOAD_STORE_SAFE(LOAD_F32)
  WASM_LOAD_STORE_SAFE(STORE_I32)
  WASM_LOAD_STORE_SAFE(STORE_F32)
  WASM_LOAD_STORE_SAFE(LOAD32_S_I64)
  WASM_LOAD_STORE_SAFE(LOAD32_U_I64)
  WASM_LOAD_STORE_SAFE(STORE32_I64)
  WASM_LOAD_STORE_SAFE(ATOMIC_LOAD_I32)
  WASM_LOAD_STORE_SAFE(ATOMIC_LOAD32_U_I64)
  WASM_LOAD_STORE_SAFE(ATOMIC_STORE_I32)
  WASM_LOAD_STORE_SAFE(ATOMIC_STORE32_I64)
  ...
  return 2;
  WASM_LOAD_STORE_SAFE(LOAD_I64)
  WASM_LOAD_STORE_SAFE(LOAD_F64)
  WASM_LOAD_STORE_SAFE(LOAD_HANDLE)
  WASM_LOAD_STORE_SAFE(STORE_I64)
  WASM_LOAD_STORE_SAFE(STORE_F64)
  WASM_LOAD_STORE_SAFE(STORE_HANDLE)
  WASM_LOAD_STORE_SAFE(ATOMIC_LOAD_I64)
  WASM_LOAD_STORE_SAFE(ATOMIC_STORE_I64)
